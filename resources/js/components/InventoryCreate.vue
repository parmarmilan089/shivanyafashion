                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="button" class="btn btn-sm btn-dark" @click="addSizeRow(vIndex)">Add
                                    Size</button>
                                <button v-if="form.variants.length > 1" type="button" class="btn btn-sm btn-danger"
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6 my-2">
                                <div class="file-div">
                                    ...
                                    <div v-if="variant.main_image" class="mt-2">
                                        <img :src="variant.main_image_preview" alt="Variant Main Image Preview"
                            ...
                            <div class="col-md-6 my-2">
                                <div class="file-div">
                                    ...
                                    <div v-if="variant.gallery_images.length > 0" class="gallery-container">
                                        <div v-for="(img, index) in variant.gallery_images" :key="index"
                                            style="display: inline-block; margin: 5px; position: relative;">
                                            <img :src="img.preview" :alt="`Gallery Image ${index + 1}`"
                                                style="max-width: 80px; height: 80px; object-fit: cover; border-radius: 8px;" />
                                            <button type="button" @click="removeGalleryImage(vIndex, index)"
...
export default {
    ...
    methods: {
        ...
        validateForm() {
            ...
            if (!this.form.fabric || this.form.fabric.trim() === '') {
            ...
            this.form.variants.forEach((variant, variantIndex) => {
                ...
                // Check if variant has main image
                ...
                if (variant.gallery_images && variant.gallery_images.length > 0) {
                    variant.gallery_images.forEach((image, imageIndex) => {
                        if (image.file instanceof File) {
                            formData.append(`variant_gallery_images[${variantIndex}][${imageIndex}]`, image.file);
                        }
                    });
                }
            });
