          ...
          <div v-for="(variant, vIndex) in form.variants" :key="vIndex" class="variant-block border p-3 mb-4 bg-white">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
              ...
              <div class="d-flex gap-2 mt-4">
                ...
                <button v-if="form.variants.length > 1" type="button" class="btn btn-sm btn-danger" @click="removeVariant(vIndex)">
              ...
              <div class="col-md-6 my-2">
                <div class="file-div">
                  ...
                  <div v-if="variant.main_image" class="mt-2">
                    <img :src="variant.main_image_preview" alt="Variant Main Image Preview" style="max-width: 120px;" />
                  </div>
                </div>
              </div>
              <div class="col-md-6 my-2">
                <div class="file-div">
                  ...
                  <div v-if="variant.gallery_images.length > 0" class="gallery-container">
                    <div v-for="(img, index) in variant.gallery_images" :key="index" style="display: inline-block; margin: 5px; position: relative;">
                      <img :src="img.preview" :alt="`Gallery Image ${index + 1}`" style="max-width: 80px; height: 80px; object-fit: cover; border-radius: 8px;" />
                      <button
                        type="button"
                        @click="removeGalleryImage(vIndex, index)"
