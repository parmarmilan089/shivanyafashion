            ...
            <div class="col-md-6 mb-md-0 mb-4">
                <div class="product-image-slider">
                    ...
                    <div class="main-image-container">
                        <img id="mainImage" :src="currentMainImage" class="main-product-image" :alt="product.name">

                        <!-- Navigation Arrows -->
                        <button v-if="allImages.length > 1" @click="previousImage"
                            class="slider-nav-btn slider-nav-prev" :disabled="currentImageIndex === 0">
                            <i class="fas fa-chevron-left"></i>
                        </button>
                        <button v-if="allImages.length > 1" @click="nextImage" class="slider-nav-btn slider-nav-next"
                    ...
                    <div v-if="allImages.length > 1" class="thumbnail-container">
                        <div v-for="(img, idx) in allImages" :key="idx" class="thumbnail-item"
                            :class="{ 'active': idx === currentImageIndex }" @click="setCurrentImage(idx)">
                            <img :src="img" class="thumbnail-image" :alt="`${product.name} - Image ${idx + 1}`">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 position-sticky top-0">
                ...
                <div class="mb-3">
                    ...
                    <div class="color-options d-flex gap-2 flex-wrap">
                        <button v-for="color in colorOptions" :key="color.color_id" type="button" class="color-option"
                            :class="{ 'active': selectedColor === color.color_id }" @click="selectColor(color.color_id)"
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <label v-for="size in sizeOptions" :key="size.size_id" class="size-radio-container">
                            <input type="radio" class="size-radio-input" :value="size.size_id" v-model="selectedSize"
                                @change="onSizeChange">
                ...
                <div v-if="product.full_description" class="product-full-description mb-3">
                    <button @click="showFullDescription = !showFullDescription"
                        class="btn btn-link p-0 text-decoration-none" type="button">
                ...
                <div class="mb-sm-4 mb-3 d-flex align-items-center gap-3 flex-sm-row flex-column">
                    <div class="input-group-qut d-flex align-items-center gap-2 justify-content-between">
                        <button @click="updateQty(-1)"
                            class="d-flex align-items-center justify-content-center border-0 p-0 bg-transparent btn-qt">-</button>
                        <input type="number" v-model.number="quantity" class="p-0 border-0 bg-transparent text-center"
                            min="1">
                        <button @click="updateQty(1)"
                            class="d-flex align-items-center justify-content-center border-0 p-0 bg-transparent btn-qt">+</button>
                    </div>
