...
<section class="col-md-9">
  <div class="row g-4">
    <div v-for="product in products.data || []" :key="product.id" class="col-sm-6 col-lg-4">
  ...
  console.log("Fetching products with filters:", this.filters, "page:", page);
    ...
    .catch((error) => {
      ...
      variantImage(product) {
        if (
          ...
          return "/" + product.variants[0].main_image;
        }
